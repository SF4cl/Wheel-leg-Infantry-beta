...
#define FALLOW_ANGLE              										66.0f
#define ROTING_SPEED																	5.0f
...
#define FOLLOW_KD																			500.0f

#define TURN_KP																				4500.0f
#define TURN_KI																				0.0f
#define TURN_KD																				10000.0f

#define ROLL_KP																				0.24f
#define ROLL_KI																				0.000f
...
#define JOINT_W 																			0
#define JOINT_T 																			0
#define JOINT_RIGHT1_ID 															2
#define JOINT_RIGHT2_ID 															0
